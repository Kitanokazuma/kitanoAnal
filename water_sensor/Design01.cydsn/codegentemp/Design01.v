...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=2073600, ADC_Input_Range=0, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=1.024, Ref_Voltage_mV=1024, rm_int=false, Sample_Precharge=6, Sample_Rate=115200, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=water_sensor, CY_INSTANCE_SHORT_NAME=water_sensor, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=water_sensor, )
module ADC_SAR_v3_0_0 (
	...
	cy_clock_v1_0
		#(.id("02722b7a-a878-4018-901b-7f8ad833f6da/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("482253086.419753"),
		  .is_direct(0),
		  .is_digital(1))
		theACLK
		 (.clock_out(Net_376));
	...
	cy_psoc3_pins_v1_10
		#(.id("02722b7a-a878-4018-901b-7f8ad833f6da/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__water_level_Pin_net;
	wire [0:0] tmpFB_0__water_level_Pin_net;
	wire [0:0] tmpIO_0__water_level_Pin_net;
	wire [0:0] tmpINTERRUPT_0__water_level_Pin_net;
	electrical [0:0] tmpSIOVREF__water_level_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		water_level_Pin
		 (.oe(tmpOE__water_level_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__water_level_Pin_net[0:0]}),
		  .analog({Net_22}),
		  .io({tmpIO_0__water_level_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__water_level_Pin_net),
		  .interrupt({tmpINTERRUPT_0__water_level_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__water_level_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
